...
router.route('/companies').put((...args) => { CompanyController_1.default.UpdateAsync(...args); });
router.route('/companies').delete((...args) => { CompanyController_1.default.DeleteAsync(...args); });
